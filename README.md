...
Data Profile: Numeric :- Age (18 to 66 years), Height (145 cm to 188 cm), Weight (51 kg to 132 kg), Premium Price (₹15,000 to ₹40,000 )
...
Medium Blog Post: Predict Health Insurance Cost with Machine Learning and Streamlit
...
Both the apps use saved machine learning models fit on example dataset using joblib.
